...
def parse_args():
    ...
    parser.add_argument('--rgb-list', default='/kaggle/working/train_label', help='list of rgb features ')
    parser.add_argument('--test-rgb-list', default='/kaggle/working/test_label', help='list of test rgb features')

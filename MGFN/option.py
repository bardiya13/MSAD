...
def parse_args():
    ...
    parser.add_argument('--test-rgb-list', default='/kaggle/working/MSAD/MGFN/data/msad/msad-i3d-test-new.list', help='list of test rgb features')
    parser.add_argument('--gt', default='/kaggle/working/MSAD/MGFN/data/msad/gt-MSAD-WS.npy', help='file of ground truth ')
    parser.add_argument('--mag_ratio', type=float, default=0.1, help='mag ratio')
    parser.add_argument('--comment', default='mgfn', help='comment for the ckpt name of the training')

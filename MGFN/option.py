...
def parse_args():
    ...
    def parse_args():
        ...
        parser.add_argument('--feature_size', type=int, default=2048,
                            help='size of feature (default: UCF:2048//xd:1024)')
        ...
        # Original path lists
        parser.add_argument('--rgb-list', default='rgb.list', help='list of rgb features ')
        parser.add_argument('--test-rgb-list', default='rgb_test.list', help='list of test rgb features')

        # New parameters for folder structure
        parser.add_argument('--labels_folder', type=str, default='data/labels',
                            help='folder containing label .npy files')
        parser.add_argument('--features_folder', type=str, default='data/features',
                            help='folder containing feature extraction .npy files')
        parser.add_argument('--train_features_list', type=str, default='train_features.txt',
                            help='text file with train frame feature names')
        parser.add_argument('--test_features_list', type=str, default='test_features.txt',
                            help='text file with test frame feature names')
        ...
        parser.add_argument('--add_mag_info', action='store_true', help='whether to add magnitude information')
        ...
        parser.add_argument('--lr', type=str, default='[0.001]*15000',
                            help='learning rates for steps(list form) default:0.001')
        ...
        parser.add_argument('--datasetname', default='MSAD',
                            help='dataset to train on (default:UCF/XD/UCF-bg-fg-sepa )')  # !!!

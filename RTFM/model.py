...
class Aggregate(nn.Module):
    def __init__(self, len_feature):
        ...
        self.conv_1 = nn.Sequential(
            nn.Conv1d(in_channels=len_feature, out_channels=512, kernel_size=3,   # default = 512
        ...
        self.conv_4 = nn.Sequential(
            nn.Conv1d(in_channels=2048, out_channels=512, kernel_size=1,   # default = 2048, 512
        ...
        self.non_local = NONLocalBlock1D(512, sub_sample=False, bn_layer=True)  # default = 512
...
class Model(nn.Module):
    def __init__(self, n_features, batch_size):
        ...
        self.Aggregate = Aggregate(len_feature=2048)  # default = 2048

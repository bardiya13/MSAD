...
parser.add_argument('--rgb-list', default='list/ped2-i3d-train.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='list/ped2-i3d-test.list', help='list of test rgb features ')
parser.add_argument('--gt', default='list/gt-ped2npy', help='file of ground truth ')
